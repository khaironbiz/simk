                            ...
                            <div class="card-body">
                                <table class="table">
                                    <tr>
                                        ...
                                        <?php
                                        $no=1;
                                        $sql_hasil      = mysqli_query($host,"SELECT nama_calon FROM muskom_survey WHERE nira='' LIMIT 1 ");
                                        while($data_survey= mysqli_fetch_array($sql_hasil)){
                                            ...
                                            $nira_ini   = $nira['nira'];
                                            $update     = mysqli_query($host,"UPDATE muskom_survey SET nira ='$nira_ini' WHERE nama_calon='$nama'");
                                            if($update){
