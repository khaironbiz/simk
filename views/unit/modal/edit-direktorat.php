...
<button type="button" class="btn btn-success btn-sm" data-toggle="modal" data-target="#exampleModal<?= $data['has_rs_direktorat']?>">
    Edit
</button>
<!-- Modal -->
<form action="" method="POST">
    <div class="modal fade" id="exampleModal<?= $data['has_rs_direktorat']?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-body">
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            ...
                            <input type="hidden" class="form-control" readonly name="key" value="<?= $data['has_rs_direktorat']?>">
                        </div>
                        <label class="col-sm-3 col-form-label">Nama Direktorat</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="nama_direktorat_edit" value="<?= $data['nama_direktorat'];?>">
                        </div>
